...
import com.example.chatapp.utils.ANIMATION_FAST_MILLIS
import com.example.chatapp.utils.ANIMATION_SLOW_MILLIS
import com.example.chatapp.utils.getFingerSpacing
import com.example.chatapp.utils.simulateClick
...
class CameraFragment : Fragment() {
    ...
    override fun onPause() {
        ...
        //TODO onPause()
        Log.e("shuddown()", cameraExecutor.toString())
        Log.e("camera Executor", cameraExecutor.isShutdown.toString())
        // Shut down our background executor
        customLifecycle.destroy()
        cameraExecutor.shutdown()
        Log.e("camera Executor", cameraExecutor.isShutdown.toString())

        Log.e("camera Executor", camera?.cameraControl?.enableTorch(true).toString())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*view.setOnClickListener {
            Toast.makeText(context, "onclick listener", Toast.LENGTH_SHORT).show()
        }*/
    }
        ...
        controls.findViewById<ImageButton>(R.id.photo_view_button).setOnClickListener {
            ...
            if (true == outputDirectory.listFiles()?.isNotEmpty()) {
                /*Navigation.findNavController(
                    requireActivity(), R.id.view_pager // ?------? view_pager
                ).navigate(
